package com.example.basic_codelab_raemin
...
import com.example.basic_codelab_raemin.ui.theme.BasicCodelabraeminTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            BasicCodelabraeminTheme {
...
fun OnBoardingScreen(onButtonClicked: () -> Unit) {
    Surface() {
        Column(
            ...
            Text(text = "Welcome to basic of codelab")
            Button(
